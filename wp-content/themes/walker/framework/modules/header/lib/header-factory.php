...
use WalkerEdgeNamespace\Modules\Header\Types;
/**
...
class HeaderFactory {
    ...
    public function validHeaderObject($header_object = null) {
        ...
        return is_subclass_of($header_object, 'WalkerEdgeNamespace\Modules\Header\Lib\HeaderType');
    }
        ...
        if($headerType !== '') {
            switch($headerType) {
                ...
                case 'header-vertical':
                    ...
                    break; 
                case 'header-bottom':
                    $this->headerObject = new Types\HeaderBottom();
                    break;                
                default:
                    break;
            }
