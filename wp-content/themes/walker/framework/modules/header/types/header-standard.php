...
class HeaderStandard extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = walker_edge_filter_px(walker_edge_options()->getOptionValue('menu_area_height_header_standard'));
    ...
    public function calculateHeightOfTransparency() {
        ...
        } else if (walker_edge_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '1' && walker_edge_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '') {
            $menuAreaTransparent = true;
        } else {
