...
class HeaderFullScreen extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = walker_edge_filter_px(walker_edge_options()->getOptionValue('menu_area_height_header_full_screen'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters = apply_filters('walker_edge_header_fullscreen_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } else if (walker_edge_options()->getOptionValue('menu_area_background_transparency_header_full_screen') !== '1' && walker_edge_options()->getOptionValue('menu_area_background_transparency_header_full_screen') !== '') {
            $menuAreaTransparent = true;
        } else {
