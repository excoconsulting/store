<div class="edgtf-blog-holder edgtf-blog-type-masonry edgtf-masonry-full-width edgtf-masonry-pagination-<?php echo walker_edge_options()->getOptionValue('masonry_fullwidth_pagination'); ?>">
...
<?php
	if(walker_edge_options()->getOptionValue('pagination') === 'yes') {
		$pagination_type = walker_edge_options()->getOptionValue('masonry_fullwidth_pagination');
