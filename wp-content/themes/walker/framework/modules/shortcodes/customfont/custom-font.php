<?php
namespace WalkerEdgeNamespace\Modules\Shortcodes\CustomFont;
...
class CustomFont implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Edge Custom Font', 'walker'),
				'base' => $this->getBase(),
				'category' => 'by EDGE',
				...
				'params' => array(
					...
					array(
						...
						"value" => array_flip(walker_edge_get_font_weight_array()),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => walker_edge_get_text_transform_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
	...
	public function render($atts, $content = null) {
		...
		$html = walker_edge_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
