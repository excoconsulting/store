<?php
namespace WalkerEdgeNamespace\Modules\Shortcodes\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface{
	...
	public function vcMap() {
		if(function_exists('vc_map')){
			vc_map( 
				array(
					'name' => esc_html__('Edge Elements Holder Item', 'walker'),
					'base' => $this->base,
					...
					'params' => array(
						array(
							'type' => 'textfield',
							'class' => '',
							'heading' => 'Link Around Holder Item',
							'param_name' => 'holder_link',
							'value' => '',
							'description' => ''
						),
						array(
	                        'type'        => 'dropdown',
	                        'heading'     => 'Link Target',
	                        'param_name'  => 'holder_link_target',
	                        'value'       => array(
	                            'Same Window'  => '_self',
	                            'New Window' => '_blank'
	                        ),
	                        'save_always' => true,
	                        'dependency' => array('element' => 'holder_link', 'not_empty' => true)
	                    ),
						array(
							'type' => 'colorpicker',
							'class' => '',
	...
	public function render($atts, $content = null) {
		...
		$html = walker_edge_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
