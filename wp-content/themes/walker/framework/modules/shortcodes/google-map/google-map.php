<?php
namespace WalkerEdgeNamespace\Modules\Shortcodes\GoogleMap;
...
class GoogleMap implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Edge Google Map', 'walker'),
				'base' => $this->base,
				'category' => 'by EDGE',
				...
				'params' => array(
					...
					array(
						'type' => 'dropdown',
						'heading' => 'Terrain Type',
						'param_name' => 'terrain_type',
						'value' => array(
							'Roadmap' => 'ROADMAP',
							'Terrain' => 'TERRAIN',
							'Satellite' => 'SATELLITE',
	...
	public function render($atts, $content = null) {
		...
		$html = walker_edge_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
	...
	private function getMapDate($params, $id) {
		...
		$map_data[] = 'data-terrain-type='. $params['terrain_type'];
