<?php
namespace WalkerEdgeNamespace\Modules\Shortcodes\Separator;
...
class Separator implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Edge Separator', 'walker'),
				'base' => $this->base,
				'category' => 'by EDGE',
	...
	public function render($atts, $content = null) {
		...
		$html = walker_edge_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(walker_edge_string_ends_with($params['width'], '%') || walker_edge_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(walker_edge_string_ends_with($params['top_margin'], '%') || walker_edge_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(walker_edge_string_ends_with($params['bottom_margin'], '%') || walker_edge_string_ends_with($params['bottom_margin'], 'px')) {
