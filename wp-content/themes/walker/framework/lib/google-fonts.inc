<?php
if ( ! function_exists( 'walker_edge_init_google_fonts_array' ) ) {
    function walker_edge_init_google_fonts_array() {

        global $walker_edge_fonts_array;
        $walker_edge_fonts_array =
         array(
             0   =>
                 array(
    ...
    add_action('after_setup_theme', 'walker_edge_init_google_fonts_array');
}