					...
					<thead>
						<tr>
							...
							<th class="wc-checkout-add-on-name">
								...
								<?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'Add-on name displayed in the admin and order details, e.g., "Gift Message"', 'woocommerce-checkout-add-ons' ) ); ?>
							</th>
							<th class="wc-checkout-add-on-label">
								<?php esc_html_e( 'Checkout Label', 'woocommerce-checkout-add-ons' ); ?>
								<?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'Optional descriptive label shown on checkout, e.g., "Add a Gift Message?". This will default to Name if blank.', 'woocommerce-checkout-add-ons' ) ); ?>
							</th>
							...
							<th class="wc-checkout-add-on-options-costs">
								...
								<?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'Use Pipe (|) to separate options and surround options with double stars (**) to set as a default. To set a price for an option, append it to the option with an equation mark. Example: Yes=5.00|No', 'woocommerce-checkout-add-ons' ) ); ?>
							</th>
