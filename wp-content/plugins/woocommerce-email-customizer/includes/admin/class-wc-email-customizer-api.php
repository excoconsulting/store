...
class WC_Email_Customizer_API {
	...
	public function add_styles( $styles ) {
		...
		$bg_color = 'body, body > div { background-color:' . get_option( 'woocommerce_email_background_color', '#f5f5f5' ) . '; }' . PHP_EOL;
		...
		$header_bg_color = '#template_header { background-color:' . get_option( 'woocommerce_email_header_background_color', '#557da1' ) . '; }' . PHP_EOL;
