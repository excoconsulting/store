 ...
 * Plugin URI: http://woothemes.com/products/woocommerce-email-customizer/
...
class WC_Email_Customizer {
	...
	public function __construct() {
		...
		define( 'WC_EMAIL_CUSTOMIZER_VERSION', '1.1.5' );
		...
		if ( is_woocommerce_active() ) {
			...
			include( 'includes/admin/class-wc-email-customizer-api.php' );

			if ( is_admin() ) {
				include( 'includes/admin/class-wc-email-customizer-admin.php' );
			}
