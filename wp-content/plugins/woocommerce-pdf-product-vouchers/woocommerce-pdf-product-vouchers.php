...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.4.0', __( 'WooCommerce PDF Product Vouchers', 'woocommerce-pdf-product-vouchers' ), __FILE__, 'init_woocommerce_pdf_product_vouchers', array(
...
class WC_PDF_Product_Vouchers extends SV_WC_Plugin {
	...
	private function includes() {
		...
		$this->my_account = $this->load_class( '/includes/class-wc-pdf-product-vouchers-my-account.php', 'WC_PDF_Product_Vouchers_My_Account' );

		$this->taxonomy = $this->load_class( '/includes/class-wc-pdf-product-vouchers-taxonomy.php', 'WC_PDF_Product_Vouchers_Taxonomy' );
	...
	/**
	 * Return taxonomy class instance
	 *
	 * @since 2.6.0
	 * @return \WC_PDF_Product_Vouchers_Taxonomy
	 */
	 ...
	 *
	 * @TODO Remove this as part of WC 2.7 compat {TZ 2016-05-26}
	 *
