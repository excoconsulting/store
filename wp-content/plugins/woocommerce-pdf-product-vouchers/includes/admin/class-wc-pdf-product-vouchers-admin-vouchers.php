...
class WC_PDF_Product_Vouchers_Admin_Vouchers {
	...
	public function enter_title_here( $text, $post ) {
		if ( 'wc_voucher' == $post->post_type ) return __( 'Voucher Name', 'woocommerce-pdf-product-vouchers' );
		return $text;
	}
	...
	public static function wc_vouchers_wp_font_select( $field ) {
		...
		echo '<input type="text" style="width:auto;margin-left:10px;" size="2" name="' . $field['id'] . '_font_size" id="' . $field['id'] . '_font_size" value="' . esc_attr( $font_size_value ) . '" placeholder="' . __( 'Size', 'woocommerce-pdf-product-vouchers' ) . '" /> ';

		echo '<label for="' . $field['id'] . '_font_style_b" style="width:auto;margin:0 5px 0 10px;">' . __( 'Bold', 'woocommerce-pdf-product-vouchers' ) . '</label><input type="checkbox" class="checkbox" style="margin-top:4px;float:left;" name="' . $field['id'] . '_font_style_b" id="' . $field['id'] . '_font_style_b" value="yes" ';
		checked( false !== strpos( $font_style_value, 'B' ), true );
		echo ' /> ';

		echo '<label for="' . $field['id'] . '_font_style_i" style="width:auto;margin:0 5px 0 10px;">' . __( 'Italic', 'woocommerce-pdf-product-vouchers' ) . '</label><input type="checkbox" class="checkbox" style="margin-top:4px;" name="' . $field['id'] . '_font_style_i" id="' . $field['id'] . '_font_style_i" value="yes" ';
	...
	public static function wc_vouchers_wp_position_picker( $field ) {
		...
		echo '<p class="form-field"><label>' . $field['label'] . '</label><input type="button" id="' . $field['id'] . '" class="set_position button" value="' . esc_attr__( 'Set Position', 'woocommerce-pdf-product-vouchers' ) . '" style="width:auto;" /> <input type="button" id="remove_' . $field['id'] . '" class="remove_position button" value="' . esc_attr__( 'Remove Position', 'woocommerce-pdf-product-vouchers' ) . '" style="width:auto;' . ( $field['value'] ? '' : 'display:none' ) . ';margin-left:7px;" />';

		if ( isset( $field['description'] ) && $field['description'] ) {

			if ( isset( $field['desc_tip'] ) ) {
				echo SV_WC_Plugin_Compatibility::wc_help_tip( $field['description'] );
			} else {
	...
	public function add_meta_boxes() {
		...
		add_meta_box(
			...
			__( 'Primary Voucher Image <small>&ndash; Used to lay out the voucher fields found in the Voucher Data box.</small>', 'woocommerce-pdf-product-vouchers' ),
		...
		add_meta_box(
			...
			__( 'Voucher Data', 'woocommerce-pdf-product-vouchers' ),
		...
		add_meta_box(
			...
			__( 'Alternative Images <small>&ndash; Optional alternative images with the same layout and dimensions as the primary image, which your customers may choose from.</small>', 'woocommerce-pdf-product-vouchers' ),
		...
		add_meta_box(
			...
			__( 'Additional Image <small>&ndash; Optional image with the same dimensions as the primary voucher image, that will be added as a second page to the voucher.</small>', 'woocommerce-pdf-product-vouchers' ),
	...
	public function additional_images_meta_box() {
		...
		<p>
			<a title="<?php esc_attr_e( 'Set additional image', 'woocommerce-pdf-product-vouchers' ) ?>" href="#" id="set-additional-image" style="<?php echo ( $image_id ? 'display:none;' : '' ); ?>"><?php _e( 'Set additional image', 'woocommerce-pdf-product-vouchers' ) ?></a>
			<a title="<?php esc_attr_e( 'Remove additional image', 'woocommerce-pdf-product-vouchers' ) ?>" href="#" id="remove-additional-image" style="<?php echo ( ! $image_id ? 'display:none;' : '' ); ?>"><?php _e( 'Remove additional image', 'woocommerce-pdf-product-vouchers' ) ?></a>
		</p>
		<?php
	}
	...
	public function alternative_images_meta_box() {
		...
		?>
		<p style="clear:left;">
			<a title="<?php esc_attr_e( 'Add an alternative voucher image', 'woocommerce-pdf-product-vouchers' ) ?>" href="#" id="add-alternative-voucher-image"><?php _e( 'Add an alternative voucher image', 'woocommerce-pdf-product-vouchers' ) ?></a>
		</p>
		<?php
	}
				...
				<?php
					...
					echo '<div class="options_group">';
						WC_PDF_Product_Vouchers_Admin_Vouchers::wc_vouchers_wp_font_select( array(
							'id'                => '_voucher',
							'label'             => __( 'Default Font', 'woocommerce-pdf-product-vouchers' ),
							'options'           => $default_fonts,
							'font_size_default' => 11,
						) );
						woocommerce_wp_text_input( array(
							'id'          => '_voucher_font_color',
							'label'       => __( 'Default Font color', 'woocommerce-pdf-product-vouchers' ),
							'default'     => '#000000',
							'description' => __( 'The default text color for the voucher.', 'woocommerce-pdf-product-vouchers' ),
							'class'       => 'colorpick',
						) );
						woocommerce_wp_select( array(
							'id'          => '_voucher_text_align',
							'label'       => __( 'Default Text Alignment', 'woocommerce-pdf-product-vouchers' ),
							'description' => __( 'The default text alignment', 'woocommerce-pdf-product-vouchers' ),
							'options'     => array(
								'L' => _x( 'Left', 'left justified', 'woocommerce-pdf-product-vouchers' ),
								'C' => _x( 'Center', 'center justified', 'woocommerce-pdf-product-vouchers' ),
								'R' => _x( 'Right', 'right justified', 'woocommerce-pdf-product-vouchers' ),
							),
						) );
					echo '</div>';
					...
					echo '<div class="options_group">';
						WC_PDF_Product_Vouchers_Admin_Vouchers::wc_vouchers_wp_position_picker( array(
							'id'          => 'product_name_pos',
							'label'       => __( 'Product Name Position', 'woocommerce-pdf-product-vouchers' ),
							'value'       => implode( ',', $voucher->get_field_position( 'product_name' ) ),
							'description' => __( 'Optional position of the product name', 'woocommerce-pdf-product-vouchers' ),
						) );
						...
						woocommerce_wp_select( array(
							...
							'label'       => __( 'Text Alignment', 'woocommerce-pdf-product-vouchers' ),
					...
					echo '<div class="options_group">';
						WC_PDF_Product_Vouchers_Admin_Vouchers::wc_vouchers_wp_position_picker( array(
							'id'          => 'product_sku_pos',
							'label'       => __( 'SKU Position', 'woocommerce-pdf-product-vouchers' ),
							'value'       => implode( ',', $voucher->get_field_position( 'product_sku' ) ),
							'description' => __( 'Optional position of the product SKU', 'woocommerce-pdf-product-vouchers' ),
						) );
						woocommerce_wp_hidden_input( array(
							'id'    => '_product_sku_pos',
							'class' => 'field_pos',
					...
					echo '<div class="options_group">';
						WC_PDF_Product_Vouchers_Admin_Vouchers::wc_vouchers_wp_position_picker( array(
							...
							'label'       => __( 'Voucher Number Position', 'woocommerce-pdf-product-vouchers' ),
							'value'       => implode( ',', $voucher->get_field_position( 'voucher_number' ) ),
							'description' => __( 'Optional position of the voucher number', 'woocommerce-pdf-product-vouchers' ),
						) );
						woocommerce_wp_hidden_input( array(
					...
					echo '<div class="options_group">';
						WC_PDF_Product_Vouchers_Admin_Vouchers::wc_vouchers_wp_position_picker( array(
							...
							'label'       => __( 'Product Price Position', 'woocommerce-pdf-product-vouchers' ),
							'value'       => implode( ',', $voucher->get_field_position( 'voucher_product_price' ) ),
							'description' => __( 'Optional position of the product price', 'woocommerce-pdf-product-vouchers' ),
						) );
						woocommerce_wp_hidden_input( array(
					...
					echo '<div class="options_group">';
						WC_PDF_Product_Vouchers_Admin_Vouchers::wc_vouchers_wp_position_picker( array(
							...
							'label'       => __( 'Expiration Date Position', 'woocommerce-pdf-product-vouchers' ),
							'value'       => implode( ',', $voucher->get_field_position( 'expiration_date' ) ),
							'description' => __( 'Optional position of the voucher expiration date', 'woocommerce-pdf-product-vouchers' ),
						) );
						woocommerce_wp_hidden_input( array(
					...
					echo '<div class="options_group">';
						WC_PDF_Product_Vouchers_Admin_Vouchers::wc_vouchers_wp_position_picker( array(
							...
							'label'       => __( 'Recipient Name Position', 'woocommerce-pdf-product-vouchers' ),
							'value'       => implode( ',', $voucher->get_field_position( 'recipient_name' ) ),
							'description' => __( 'Optional position of the name of the receiving party.', 'woocommerce-pdf-product-vouchers' ),
						) );
						woocommerce_wp_hidden_input( array(
						...
						woocommerce_wp_text_input( array(
							...
							'description' => __( 'The maximum number of characters of the recipient name field', 'woocommerce-pdf-product-vouchers' ),
						...
						woocommerce_wp_checkbox( array(
							...
							'description' => __( 'Display this field on the product page (useful if you want the Recipient Name option without printing it to the voucher)', 'woocommerce-pdf-product-vouchers' ),
					...
					echo '<div class="options_group">';
						WC_PDF_Product_Vouchers_Admin_Vouchers::wc_vouchers_wp_position_picker( array(
							...
							'label'       => __( 'Recipient Email Position', 'woocommerce-pdf-product-vouchers' ),
							'value'       => implode( ',', $voucher->get_field_position( 'recipient_email_pos' ) ),
							'description' => __( 'Optional position of the user-supplied recipient email', 'woocommerce-pdf-product-vouchers' ),
						) );
						woocommerce_wp_hidden_input( array(
							'id'    => '_recipient_email_pos',
							'class' => 'field_pos',
							'value' => implode( ',', $voucher->get_field_position( 'recipient_email' ) ),
						) );
						WC_PDF_Product_Vouchers_Admin_Vouchers::wc_vouchers_wp_font_select( array(
							'id'      => '_recipient_email',
							'label'   => __( 'Font', 'woocommerce-pdf-product-vouchers' ),
						...
						woocommerce_wp_checkbox( array(
							...
							'label'       => __( 'Enabled', 'woocommerce-pdf-product-vouchers' ),
							'description' => __( 'Display this field on the product page (useful if you want the Recipient Email option without printing it to the voucher)', 'woocommerce-pdf-product-vouchers' ),
					...
					echo '<div class="options_group">';
						WC_PDF_Product_Vouchers_Admin_Vouchers::wc_vouchers_wp_position_picker( array(
							'id'          => 'message_pos',
							'label'       => __( 'Message Position', 'woocommerce-pdf-product-vouchers' ),
							'value'       => implode( ',', $voucher->get_field_position( 'message' ) ),
							'description' => __( 'Optional position of the user-supplied message', 'woocommerce-pdf-product-vouchers' ),
						) );
						woocommerce_wp_hidden_input( array(
							'id'    => '_message_pos',
							'class' => 'field_pos',
						...
						woocommerce_wp_text_input( array(
							...
							'label'       => __( 'Max Length', 'woocommerce-pdf-product-vouchers' ),
							'description' => __( 'The maximum number of characters of the message field', 'woocommerce-pdf-product-vouchers' ),
							'placeholder' => __( 'No Limit', 'woocommerce-pdf-product-vouchers' ),
						...
						woocommerce_wp_checkbox( array(
							...
							'label'       => __( 'Enabled', 'woocommerce-pdf-product-vouchers' ),
							'description' => __( 'Display this field on the product page (useful if you want the customer to be able to add a personalized message that will be included in the recipient email without printing it to the voucher)', 'woocommerce-pdf-product-vouchers' ),
	...
	public function image_meta_box() {
		...
		<p>
			<a title="<?php esc_attr_e( 'Set voucher image', 'woocommerce-pdf-product-vouchers' ) ?>" href="#" id="set-voucher-image"><?php _e( 'Set voucher image', 'woocommerce-pdf-product-vouchers' ) ?></a>
			<a title="<?php esc_attr_e( 'Remove voucher image', 'woocommerce-pdf-product-vouchers' ) ?>" href="#" id="remove-voucher-image" style="<?php echo ( ! $image_id ? 'display:none;' : '' ); ?>"><?php _e( 'Remove voucher image', 'woocommerce-pdf-product-vouchers' ) ?></a>
		</p>
		<?php
	}
