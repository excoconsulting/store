<div class="wrap woocommerce">
	...
	<div id="message" class="updated woocommerce-message wc-connect">
		<div class="squeezer">
			...
			<p class="submit"><a href="<?php echo wc_csv_import_suite()->get_documentation_url(); ?>" class="button-primary"><?php esc_html_e( 'Documentation', 'woocommerce-csv-import-suite' ); ?></a>
				<a class="docs button-primary" href="https://docs.google.com/spreadsheets/d/16ub-_xEJD9V5UL6d_rTQ4LLu0PT9jXJ0Ti-iirlKyuU/edit#gid=0"><?php esc_html_e( 'Sample Customer CSV', 'woocommerce-csv-import-suite' ); ?></a>
				<a class="docs button-primary" href="https://docs.google.com/spreadsheets/d/16ub-_xEJD9V5UL6d_rTQ4LLu0PT9jXJ0Ti-iirlKyuU/edit#gid=620764597"><?php esc_html_e( 'Sample Coupon CSV', 'woocommerce-csv-import-suite' ); ?></a>
				<a class="docs button-primary" href="https://docs.google.com/spreadsheets/d/16ub-_xEJD9V5UL6d_rTQ4LLu0PT9jXJ0Ti-iirlKyuU/edit#gid=584795629"><?php esc_html_e( 'Sample Order CSV', 'woocommerce-csv-import-suite' ); ?></a>
			<p>
		</div>
	</div>
	...
	<div class="tool-box">
		...
		<p class="submit"><a class="button" href="<?php echo admin_url( 'admin.php?import=woocommerce_customer_csv' ); ?>"><?php esc_html_e( 'Import Customers', 'woocommerce-csv-import-suite' ); ?></a></p>
	...
	<div class="tool-box">
		...
		<p class="submit"><a class="button" href="<?php echo admin_url( 'admin.php?import=woocommerce_coupon_csv' ); ?>"><?php esc_html_e( 'Import Coupons', 'woocommerce-csv-import-suite' ); ?></a></p>
	...
	<div class="tool-box">
		...
		<p class="submit"><a class="button" href="<?php echo admin_url( 'admin.php?import=woocommerce_order_csv' ); ?>"><?php esc_html_e( 'Import Orders', 'woocommerce-csv-import-suite' ); ?></a></p>
