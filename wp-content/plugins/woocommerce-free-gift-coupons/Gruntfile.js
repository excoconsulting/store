module.exports = function(grunt) {
  ...
  grunt.initConfig({
	...
	addtextdomain: {
		options: {
            textdomain: 'wc_free_gift_coupons',    // Project text domain.
            updateDomains: [ 'woocommerce-mix-and-match', 'woocommerce-free-gift-coupons' ]  // List of text domains to replace.
        },
		target: {
			files: {
...
grunt.registerTask( 'build', [ 'replace', 'newer:uglify', 'newer:sass', 'addtextdomain', 'makepot' ] );
