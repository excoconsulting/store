...
woocommerce_quantity_input( array(
	...
	'input_value' => isset( $_REQUEST[ 'wccp_component_quantity' ][ $component_id ] ) ? $_REQUEST[ 'wccp_component_quantity' ][ $component_id ] : apply_filters( 'woocommerce_composited_product_quantity', max( $quantity_min, 1 ), $quantity_min, $quantity_max, $product, $component_id, $composite_product )
), $product );
