...
switch ($subtab){
								...
								<div class="ihc-sortable-table-wrapp">
									...
									foreach ($reg_fields as $k=>$v){
										...
										<tr class="<?php echo $tr_extra_class;?>" id="tr_<?php echo $k;?>">
											...
											<td>
												<?php 
													if($v['name']=='ihc_social_media' || $v['name']=='payment_select' || $v['name']=='ihc_invitation_code_field'){
														echo '-';
											...
											<td>
												<?php 
													if ($v['display_public_ap']==2){
														_e('Always', 'ihc');
													} else if($v['name']=='ihc_social_media' || $v['name']=='ihc_invitation_code_field'){
														echo '-';
													} else {
														?>
											...
											<td>
												<?php 
													$no_delete_fields = array('ihc_avatar', 'recaptcha', 'ihc_coupon', 'tos', 'ihc_social_media', 'confirm_email', 'payment_select', 'ihc_invitation_code_field', 'ihc_state', 'ihc_country');
	...
	case 'add_edit_cf':
		...
		if ($meta_arr['name']=='confirm_email' || $meta_arr['name']=='tos' || $meta_arr['name']=='recaptcha' 
			|| $meta_arr['name']=='ihc_avatar' || $meta_arr['name']=='ihc_coupon' || $meta_arr['name']=='payment_select' || $meta_arr['name']=='ihc_country' || $meta_arr['name']=='ihc_invitation_code_field'){
			$disabled = 'disabled';
		}
		?>
