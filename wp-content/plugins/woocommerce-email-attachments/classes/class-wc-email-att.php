...
final class WC_Email_Att
{
	...
	static public function autoload( $class_name )
	{
		...
		switch ($class_name)
		{
			case 'wc_addons_email_att':
			case 'wc_email_att_activation':
			case 'wc_email_att_admin':
			case 'wc_email_att_func':
			case 'wc_email_att_upgrade':
			case 'wc_email_att_wpml':
				include_once self::$plugin_path.'classes/class-' . $filename . '.php';
				break;
			case 'wc_email_att_panel_admin':
	...
	/**
	 * Must be called immediatly after creating the object and initialising the static variables to create the depending objects
	 * which need the static variables set
	 */
	public function init()
	{
		...
		if ( is_admin() )
		{
			$this->email_attachments_admin = new WC_Email_Att_Admin();
		}
