...
class WC_POS_Admin_Settings_CSS extends WC_Settings_Page {
	...
	public function text_style_editor_setting() {
		...
		<textarea name="wc_pos_custom_styles" id="wc_pos_custom_styles" style="width: 100%; min-height: 300px; "><?php echo $custom_styles; ?></textarea>
		<!-- Create a simple CodeMirror instance -->
		<link rel="stylesheet" href="<?php echo WC_POS()->plugin_url(); ?>/assets/plugins/codemirror/codemirror.css">
