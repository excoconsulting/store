		...
		print_barcodes: function () {
			...
			switch(type){
				case 'continuous_feed':
					...
					$('#printable_barcode').removeClass('a4').removeClass('letter').removeClass('per_sheet_80').removeClass('per_sheet_30').removeClass('a4_30');
				break;
				case 'a4':
					$('#printable_barcode').addClass('a4');
					$('#printable_barcode').removeClass('continuous_feed').removeClass('letter').removeClass('per_sheet_80').removeClass('per_sheet_30').removeClass('a4_30');
				break;
				case 'letter':
					$('#printable_barcode').addClass('letter');
					$('#printable_barcode').removeClass('continuous_feed').removeClass('a4').removeClass('per_sheet_80').removeClass('per_sheet_30').removeClass('a4_30');
				break;
				case 'per_sheet_30':
					$('#printable_barcode').addClass('per_sheet_30');
					$('#printable_barcode').removeClass('continuous_feed').removeClass('a4').removeClass('letter').removeClass('per_sheet_80').removeClass('a4_30');
				break;
				case 'per_sheet_80':
					$('#printable_barcode').addClass('per_sheet_80');
					$('#printable_barcode').removeClass('continuous_feed').removeClass('a4').removeClass('letter').removeClass('per_sheet_30').removeClass('a4_30');
				break;
				case 'a4_30':
					$('#printable_barcode').addClass('a4_30');
					$('#printable_barcode').removeClass('continuous_feed').removeClass('a4').removeClass('letter').removeClass('per_sheet_30').removeClass('per_sheet_80');
				break;
			}
			window.print(); 
		},
		...
		fields_to_print: function () {
			...
			$('#order_line_items .item').each(function(index, el) {
				...
				if( !field_sku ){
					...
					$(el).find('.barcode_border img').attr('src', barcode_url + '&font_size=12');
				}
				if( field_name ){
