...
function wc_od_delivery_modal_content() {
	...
	<div class="row">
		<div class="half-column columns">
			<div class="column-wrap">
				<label><?php _e( 'Country', 'woocommerce-order-delivery' ); ?></label>
				<select name="country" data-placeholder="<?php _e( 'Select a country&hellip;', 'woocommerce-order-delivery' ); ?>">
					<option></option>
		...
		<div class="half-column columns">
			<div class="column-wrap">
				<label><?php _e( 'States', 'woocommerce-order-delivery' ); ?></label>
				<input name="states" type="hidden" data-placeholder="<?php _e( 'Select the states&hellip;', 'woocommerce-order-delivery' ); ?>" value="" />
			</div>
		</div>
	</div>
