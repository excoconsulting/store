...
class WC_Brands {
	...
	public function register_hooks() {
		...
		add_filter( 'woocommerce_rest_prepare_product', array( $this, 'rest_api_add_brands_to_product' ), 10, 2 );
	}
	...
	public function init_widgets() {
		...
		if ( version_compare( WC_VERSION, '2.6.0', '>=' ) ) {
			...
			require_once( 'widgets/class-wc-widget-brand-nav-deprecated.php' );
		}
	...
	public function rest_api_register_routes() {
		...
		require_once( $this->plugin_path() . '/classes/class-wc-brands-rest-api-controller.php' );
