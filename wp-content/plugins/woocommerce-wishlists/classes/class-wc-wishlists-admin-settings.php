...
class WC_Wishlists_Settings_Admin {
	...
	function init_form_fields() {
		...
		$this->fields['wc_wishlists_main'] = apply_filters( 'woocommerce_wishlists_options_settings_fields', array(
			...
			'desc' => '<br />If set to Yes, guests can create create lists. <br />If set to No guests will not see any whishlist buttons and can not create new lists.  <br />If set to Registration Required, guests will see the Add to Wishlist button, but they will be required to logon or register before completing the action.',
			'id' => 'wc_wishlist_guest_enabled',
			'type' => 'select',
			'std' => 'enabled',
			'default' => 'enabled',
			'options' => array('enabled' => 'Yes', 'disabled' => 'No', 'registration_required' => 'Registration Required')
		    ),
