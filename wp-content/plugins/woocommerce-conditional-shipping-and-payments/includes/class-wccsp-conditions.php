...
class WC_CSP_Conditions {
	...
	private function get_admin_condition_fields( $scope, $restriction_id, $index, $options = array() ) {
		...
		?><h4><?php
			...
			echo WC_CSP_Core_Compatibility::wc_help_tip( __( 'All <strong>defined</strong> conditions must apply <strong>simultaneously</strong> for the restriction to come into effect. Add multiple restriction instances to create complex rules.', 'woocommerce-conditional-shipping-and-payments' ) ); ?>
		</h4><?php
