...
class WC_Deposits_Cart_Manager {
	...
	public function __construct() {
		...
		//Dynamic Pricing applies discounts after the cart is completely loaded to account for category quantity discounts.
	...
	public function display_cart_totals_after() {
		...
		<td><strong><?php echo wc_price( $future_payment_amount ); ?></strong><?php echo $tax_element; ?></td>
		</tr><?php
	}
